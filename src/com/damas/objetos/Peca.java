...
public interface Peca {
    ...
    /**
     * Movimenta a peca para uma nova casa. Antes de trocar de casa a Peca armazena
     * a casa no
     * campo ultimaCasa, isso servirá para verificar qual sentido em que a peça se
     * moveu para
     * implementar a lógica de comer peças.
     * 
     * @param destino nova casa que ira conter esta peca.
     */
    void mover(Casa origem, Casa destino);
